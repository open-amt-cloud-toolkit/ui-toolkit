...
export const createProfile = async (payload, rpsServer: string): Promise<any> => await HttpClient.post(`http://${rpsServer}/api/v1/admin/profiles/`, JSON.stringify(payload
))
