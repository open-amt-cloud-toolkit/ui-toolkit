...
export class CustomHeader extends React.Component<HeaderParams, { isMouseOver: boolean, message: string }> {
  ...
  /**
     ...
     */
  prepareTooltipStyle = (event): void => {
    const gridPosition: any = document.getElementById('grid-wrapper')
    const gridLeftPosition: any = gridPosition.getBoundingClientRect().left
  ...
  render (): React.ReactNode {
    const menu = <div className={`customHeaderMenuButton ${this.props.displayName}`}
