...
describe("Test powerActionsServices function component", () => {
    ...
    it('Test powerActions function', () => {
        ...
        HttpClient.post = jest.fn(function(arg1,arg2){return new Promise((resolve, reject) => {
        ...
        powerActions("abcd-efgh-ijkl-lmop", 100, "1.2.3.4:1234", 'APIKEYFORMPS123!');        
    });
    ...
    it('Test getPowerState function', () => {
        ...
        getPowerState("wxyz-efgh-ijkl-lmop", "7.8.9.10:5678", 'APIKEYFORMPS123!');        
    });
